...
const Categorias = () => {
  ...
  // Estados de las imágenes cargadas
  ...
  // 2. Método para actualizar la categoría en Supabase (Imagen 5b60da)
  const actualizarCategoria = async () => {
    try {
      ...
      // Refrescar lista y mostrar éxito
  ...
  // --- Método para eliminar en Supabase (Imagen 65521b) ---
